...
function CopyRight() {
  ...
  echo "#  自动重新安装脚本                                    #"
  echo "#                                                      #"
  echo "#  作者: hiCasper & Minijer                            #"
  echo "#  上次修改时间: 2021-05-11                            #"
  echo "#                                                      #"
  echo "#  支持：by MoeClub & cxthhhhh                         #"
  echo "#                                                      #"
  echo "########################################################"
  echo -e "\n"
}
